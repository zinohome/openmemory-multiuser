...
async def create_memory(
    ...
    if not user:
        ...
        user = User(
            ...
            name=request.user_id.title(),  # "opti" becomes "Opti"
...
async def get_memory(
    ...
    # Join with User table to get creator info
    ...
    return {
        ...
        "user_id": memory.user.user_id if memory.user else "unknown",
        "user_name": memory.user.name if memory.user else "Unknown User",
        "user_display_name": memory.user.name if memory.user else "Unknown User"
    }
